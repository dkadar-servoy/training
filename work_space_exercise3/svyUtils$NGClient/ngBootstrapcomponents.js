 ...
 * @public
 *
 * @properties={typeid:24,uuid:"D1D5F667-3F72-4611-B05B-077158F8AF13"}
 */
function newField(layoutContainer, index, name, dataProvider) {
	var fld = layoutContainer.newWebComponent(name, BTS_COMPONENTS.TEXTBOX, index);
	fld.name = name;
	fld.setJSONProperty("dataProvider", dataProvider);
	return fld;
}
